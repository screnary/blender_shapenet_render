#!/home/wzj/.conda/envs/main/bin/python
...
parser.add_argument('--category',   default='chair',          type=str, help='object category (from ShapeNet or primitive, see options in config.py)')
parser.add_argument('--output',     default='output/chair/',  type=str, help='save folder')
...
def render(script, low, high, repeat, category, output):
    ...
    command = ['/usr/bin/blender', '--background', '-noaudio', '--python', script, '--', '--include', repo_folder, \
